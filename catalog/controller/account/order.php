...
class ControllerAccountOrder extends Controller {
	...
	public function add_western_union_pin() {
		...
		if (isset($this->request->post['western_union_name'])) {
			$western_union_name = $this->request->post['western_union_name'];
		} else {
			$western_union_name = '';
		}
		if (isset($this->request->post['western_union_pin'])) {
			$western_union_pin = $this->request->post['western_union_pin'];
		} else {
			$western_union_pin = '';
		}
		...
		$this->load->model('account/order');
		$state = $this->model_account_order->updateWesternUnionPin($order_id, $western_union_name, $western_union_pin);
